...
<body>
	...
	<div class="cart-items">
		<div class="container">
			<h2 class="text-center">确认收货信息</h2>
			<form class="form-horizontal" action="/order_confirm" method="post" id="payform" class="text-center">
				<div class="row">
				...
				<h3 class="text-center">支付金额: ${order.total }</h3><br><br>

...
<div class="products">
    <div class="container">
        <h2><c:choose><c:when test="${t==2}">热销商品</c:when><c:otherwise>文创产品展示</c:otherwise></c:choose></h2>
                ...
                <div class="product-grid">
                    <a href="/goods_detail?id=${g.id}">
                        ...
                        <div class="product-img b-link-stripe b-animate-go  thickbox">
                            <img src="${g.cover}" class="img-responsive" alt="${g.name}" width="200" height="200">
                            <div class="b-wrapper">
